                            ...
                            {pages.map((page) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`px-3 py-2 rounded-md text-lg font-medium transition-colors cursor-pointer ${active
                                    ...
                                    <div className="absolute right-0 mt-2 w-24 bg-white border rounded-md shadow-lg">
                                        {SUPPORTED.map((lc) => (
                                            <button
                                                ...
                                                className={`block w-full text-left px-2 py-1 text-sm hover:bg-gray-100 ${lc === locale ? "text-green-700" : ""}`}
                                            >
                                                {lc === "vi" ? "VI" : "EN"}
                                            </button>
                                        ))}
          ...
          <div className="md:hidden bg-white border-t border-gray-200">
              <div className="px-4 py-2 space-y-1">
                ...
                <button
                    ...
                    className={`px-3 py-2 border rounded-md ${lc === locale ? "bg-green-600 text-white border-green-600" : "bg-white text-gray-700 hover:bg-gray-50"}`}
                >
